...
# ----------------------------------
# Agrega datos de sensores en bruto en características estadísticas por hora
# Calcula desviaciones estándar y percentiles por sensor para detectar anomalías y degradación de señal
# Estas características agregadas se usan para entrenamiento de ML y detección en tiempo real
# ----------------------------------
