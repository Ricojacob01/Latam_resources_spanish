...
-- MAGIC %md
-- MAGIC # Cuaderno de Preparación de Datos
-- MAGIC
-- MAGIC Este cuaderno tiene como objetivo **crear tablas y datos ficticios** con fines de demostración.  
-- MAGIC Todas las estructuras utilizadas aquí (catálogo, esquema y tablas) fueron definidas solo como **ejemplo** para simulaciones controladas.  
-- MAGIC
-- MAGIC  **Catálogo de ejemplo:** `daiwt_sp_2025`  
-- MAGIC  **Esquema de ejemplo:** `digital_bank`  
-- MAGIC
-- MAGIC ## Cómo utilizar
-- MAGIC Si usas este repositorio en un entorno real, **se recomienda sustituir**:
-- MAGIC - El **catálogo** (`daiwt_sp_2025`) por el catálogo correspondiente a tu entorno.  
-- MAGIC - El **esquema** (`digital_bank`) por el esquema de tu organización.  
-- MAGIC - Los **datos ficticios** por la ingestión de tus propios datasets.  
-- MAGIC
-- MAGIC > **Atención**: Las tablas y datos aquí generados son solo para **ilustración**. No deben utilizarse como base para análisis en entornos productivos.
-- MAGIC
