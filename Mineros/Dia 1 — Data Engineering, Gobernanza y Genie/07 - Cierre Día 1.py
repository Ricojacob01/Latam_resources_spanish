...
# MAGIC
# MAGIC ## Activos que quedan en tu esquema `academia.<tu_apellido>`
# MAGIC | Capa | Tabla | Descripción |
# MAGIC |---|---|---|
# MAGIC | silver | `orders_silver` | Pedidos validados |
# MAGIC | silver | `customers_silver` | Estado actual de clientes (SCD1) |
# MAGIC | gold | `order_summary_gold` | Pedidos agregados por día |
# MAGIC | gold | `customer_summary_gold` | Resumen de clientes |
# MAGIC
# MAGIC ## 📌 Anota para mañana
# MAGIC - Tu **catálogo/esquema**: `academia.<tu_apellido>`
